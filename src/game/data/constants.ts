...
/** Staff Warning counter value at which eat cooldown activates (without Charming Personality). */
...
/** Base coins earned for eating meat at well-done (no skill required). */
export const WELL_DONE_BASE_COINS = 3; // [TUNE]

/** Additional coins earned by Perfect Grill Bonus skill per well-done eat (stacks with base). */
